...
//        System.out.println(" ");
        ...
        String time=  formatter.format(date.toInstant());

        System.out.println(time);
        ZoneId zoneId = ZoneId.of("Asia/Magadan");

        LocalDateTime localDateTime = LocalDateTime.now(zoneId);

        System.out.println("LocalDateTime by logged user" + localDateTime);

        Date dateZoneId = Date.from(localDateTime.atZone(ZoneId.systemDefault()).toInstant());

        System.out.println(dateZoneId);
    }
